...
export function SquadChat({ squad }: { squad: any }) {
  ...
  const send = (value: string) => {
    ...
    squadStore.sendMessage(squad.id, me, value);
    setText("");
  };
      ...
      <div className="border-t border-border/40 p-3 space-y-2">
        ...
        >
          <Input
            ...
            maxLength={1000}
          />
          <Button type="submit" size="icon" disabled={!me || !text.trim()} aria-label="Send message">
